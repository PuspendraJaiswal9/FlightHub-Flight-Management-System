...
public class Flight {
    ...
    public Flight(String departureCity, Long flightId, String flightNumber, String flightName, String arrivalCity, LocalDate departureDate, LocalTime departureTime, LocalDate arrivalDate, LocalTime arrivalTime, int totalSeats, int availableSeats, String status, int bookedSeat) {
